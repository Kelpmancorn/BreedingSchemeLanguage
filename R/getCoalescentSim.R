...
getCoalescentSim <- function(nPops=12, nPopsSamples=rep(100,12), effPopSize=100, nChr=31, nPiecesPerChr=180,  recBTpieces=0.0001, nMrkOrMut=100, minMAF=0.01, seed=as.integer(Sys.time()), tree=0){ ##effective population size should be larger than the sample size
