...
getCoalescentSim <- function(nPops=12, nPopsSamples=rep(24,12), effPopSize=100, nChr=31, nPiecesPerChr=180,  recBTpieces=0.0001, nMrkOrMut=100, minMAF=0.01,migration=2.5e-4, seed=as.integer(Sys.time()), tree=1){ ##effective population size should be larger than the sample size
